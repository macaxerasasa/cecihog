    ...
    <span className={`candle ${holder ? 'has-holder' : 'is-bare'} ${className}`} style={style} aria-hidden="true">
      <svg className="candle-svg" viewBox="0 0 60 180" preserveAspectRatio="xMidYMax meet">
        <defs>
          ...
          <linearGradient id="cd-wax-glow" x1="0" y1="0" x2="0" y2="1">
          ...
          <linearGradient id="cd-flame-outer" x1="0" y1="1" x2="0" y2="0">
          ...
          <filter id="cd-soft" x="-50%" y="-50%" width="200%" height="200%">
            <feGaussianBlur stdDeviation="1.6" />
          </filter>
          <filter id="cd-blur-lg" x="-50%" y="-50%" width="200%" height="200%">
            <feGaussianBlur stdDeviation="6" />
          </filter>
        </defs>

        <g className="candle-halo">
          <circle cx="30" cy="58" r="30" fill="url(#cd-halo)" />
        </g>

        {holder && (
          <g className="candle-holder">
            <ellipse cx="30" cy="172" rx="22" ry="5.5" fill="#1a0f06" opacity="0.6" />
            <path d="M8 168 Q30 160 52 168 L52 172 Q30 180 8 172 Z" fill="url(#cd-brass)" />
            <ellipse cx="30" cy="167" rx="22" ry="5" fill="url(#cd-brass)" />
            <ellipse cx="30" cy="166.4" rx="14" ry="3" fill="#2a1a08" opacity="0.5" />
            <path d="M25 165 Q23 158 27 154 L33 154 Q37 158 35 165 Z" fill="url(#cd-brass)" />
            <rect x="26.5" y="146" width="7" height="9" rx="1.5" fill="url(#cd-brass)" />
            <ellipse cx="30" cy="146" rx="6.5" ry="2" fill="#f0c860" opacity="0.9" />
            <path d="M18 140 Q30 136 42 140 L42 143 Q30 147 18 143 Z" fill="url(#cd-brass)" />
            <ellipse cx="30" cy="139.6" rx="12" ry="3.2" fill="url(#cd-brass)" />
            <ellipse cx="30" cy="139.2" rx="7.5" ry="1.9" fill="#3a2410" opacity="0.6" />
          </g>
        )}

        <g className="candle-wax">
          <rect x="20" y={waxTop} width="20" height={waxH} rx="2.2" fill="url(#cd-wax)" />
          <rect x="20" y={waxTop} width="20" height={waxH} rx="2.2" fill="url(#cd-wax-glow)" />
          <path
        ...
        <g className="candle-flame" style={{ transformOrigin: `30px ${waxTop - 2}px` }}>
          <g transform={`translate(0 ${waxTop - 74})`}>
            <ellipse cx="30" cy="58" rx="9" ry="16" fill="#ff8c2a" opacity="0.35" filter="url(#cd-blur-lg)" />
            <path
              d="M30 40 C36 50 39 58 38 65 C37 71 34 74 30 74 C26 74 23 71 22 65 C21 58 24 50 30 40 Z"
              fill="url(#cd-flame-outer)"
              filter="url(#cd-soft)"
            />
            <path
              d="M30 40 C36 50 39 58 38 65 C37 71 34 74 30 74 C26 74 23 71 22 65 C21 58 24 50 30 40 Z"
            ...
            <path
              ...
              fill="url(#cd-flame-inner)"
              opacity="0.95"
            />
            <ellipse cx="30" cy="70" rx="5" ry="4.5" fill="url(#cd-flame-blue)" />
          </g>
        </g>
      </svg>
    </span>
